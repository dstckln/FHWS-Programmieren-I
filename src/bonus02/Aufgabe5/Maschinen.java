...
public class Maschinen {
    ...
    private Motorrad head;
    private Motorrad tail;

    private void insertSorted(Motorrad motorrad) {
        Motorrad current;
    ...
    private Motorrad search(int hubraum) {
    ...
    private void delete(String modell) {
        Motorrad current = head;
